      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <p>1. Click the button as many times as you can</p>
            <p>2. Each click adds to your total score</p>
            <p>3. Your score is saved in real-time</p>
            <p>4. Players are ranked by their total clicks</p>
          </CardContent>
        </Card>
